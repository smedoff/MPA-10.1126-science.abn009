#=============
# Title: Running Difference and Difference regressions - Logbook Data
# Author: Sarah Medoff 
#=============

# The observer data only covers 20% of deep set vessels.  To test whether or not our 
# results are unique to this 20% subset, we run our regression on a larger, but less 
# reliable data set, the logbook data.  
...
# ===============================
# Running Logbook - Continous Distance 
# ===============================
