...
#=============
# Title: Running Difference and Difference regressions - Raw CPUE (Observer)
# Author: Sarah Medoff 
#=============

# The purpose of this script is run the diff in diff regressions using raw CPUE 
# as the outcome variable for each region-radii specification: 100NM, 200NM, 
# 300NM, as well as the continous distance specification.  
...
# ===============================
# Running Raw CPUE - Continous Distance 
# ===============================
